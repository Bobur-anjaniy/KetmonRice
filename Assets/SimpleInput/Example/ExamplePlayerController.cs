...
public class ExamplePlayerController : MonoBehaviour
{
	...
	public float  M_vertical = 20;
	public float  M_horizontal = 5;
	public float M2_horizontla = 1 ;
	...
	void Update()
	{
		inputHorizontal = SimpleInput.GetAxis( horizontalAxis )/ M_horizontal;
		inputVertical = SimpleInput.GetAxis( verticalAxis );

		transform.Rotate( 0f, inputHorizontal *5f / M2_horizontla * Time.deltaTime , 0f, Space.World );
